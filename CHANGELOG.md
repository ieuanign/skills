...
- [#283](https://github.com/ieuanign/skills/pull/283) [`6ee270b`](https://github.com/ieuanign/skills/commit/6ee270bc445ff87d468e4d847ea1c37c2e48a091) Thanks [@ieuanign](https://github.com/ieuanign)! - `/dev-loop`'s spine defines `<this-skill-dir>` and `<STAGED>` among its derived facts, so an
  orchestrator that no longer holds the act file still composes a correct `scriptPath`.

  [#279](https://github.com/ieuanign/skills/issues/279) moved the phase scripts out of the skill directory and into `<MAIN>/.scratch/dev-loop-scripts/`,
...
- [#280](https://github.com/ieuanign/skills/pull/280) [`c727ee1`](https://github.com/ieuanign/skills/commit/c727ee177314417b83f1a1c59462228f5ac2f365) Thanks [@ieuanign](https://github.com/ieuanign)! - `/dev-loop` stages its phase scripts into the working tree before handing them to the Workflow tool,
  ...
  **Re-staging before every use is what keeps the copy disposable.** No act file reads a copy it did not
  ...
  that `<this-skill-dir>` as the `cp` _source_ is not flagged, scans `skills/` only so the frozen [#121](https://github.com/ieuanign/skills/issues/121)
...
- [`a81edb8`](https://github.com/ieuanign/skills/commit/a81edb8db6b0cfa372959ce30dbff8b07f47e3ac) Thanks [@ieuanign](https://github.com/ieuanign)! - `/pr-comments` is one lean file, and its fix work happens in the session you invoked it from.
...
- [#247](https://github.com/ieuanign/skills/pull/247) [`ec44f7d`](https://github.com/ieuanign/skills/commit/ec44f7df2619c278275dcd18d687d4fd377857d5) Thanks [@ieuanign](https://github.com/ieuanign)! - `/dev-loop`'s `SKILL.md` is a spine over staged act files, each read at the boundary where its act
  fires.
  ...
  **The spine keeps only what binds _between_ acts** — the frontmatter, the identity paragraph,
